...
//        System.out.println(fileBackedTasksManager.restoredHistory);
        ...
        Task task1 = new Task("25", "Приготовить суп из пойманной рыбы", TaskStatus.NEW, "2021-12-21T23:20:21", 60);
        Task task2 = new Task("24", "Приготовить суп из пойманной рыбы", TaskStatus.NEW, "2021-12-21T22:21:21", 10);
        Task task3 = new Task("21", "Приготовить суп из пойманной рыбы", TaskStatus.NEW, "2021-12-21T21:22:21", 20);
        manager.addNewTask(task1);
        manager.addNewTask(task2);
        manager.addNewTask(task3);
        Epic epic1 = new Epic("Попить чай", "Приготовить чай и выпить его", TaskStatus.NEW);
        manager.addNewEpic(epic1);
        manager.addNewSubtask(new Subtask("Заварка", "Заварить заварку в чайничке", TaskStatus.DONE, "2022-12-21T23:20:22", 60, epic1.getId()));
        manager.addNewSubtask(new Subtask("Сахар", "Положить сахар и размешать", TaskStatus.NEW, "2022-12-21T23:20:23", 12, epic1.getId()));
